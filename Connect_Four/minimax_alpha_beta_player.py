...
class MinimaxAlphaBetaPlayer:
    ...
    def minimax_alpha_beta(self, game, depth, alpha, beta, maximizingPlayer):
        ...
        if maximizingPlayer:
            ...
            for col in valid_locations:
                ...
                game.drop_disc(col)
                new_score = self.minimax_alpha_beta(game, depth-1, alpha, beta, False)[1]
                game.board = b_copy
                if new_score > value:
                    value = new_score
                    best_col = col
            ...
            for col in valid_locations:
                b_copy = game.board.copy()
                game.drop_disc(col)
                new_score = self.minimax_alpha_beta(game, depth-1, alpha, beta, True)[1]
                game.board = b_copy
                if new_score < value:
                    value = new_score
                    best_col = col
    ...
    def choose_move(self, game):
        ...
        col, minimax_score = self.minimax_alpha_beta(game, self.depth, -math.inf, math.inf, True)
        end_time = time.time()
